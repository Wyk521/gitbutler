...
/**
 * {@link ../../../../../crates/but-api/src/legacy/users.rs:238}
 */
...
/**
 * {@link ../../../../../crates/but-api/src/legacy/users.rs:244}
 */
...
export type AnalysisConfigInput = {
  ...
  ownershipMaxFiles: number | null;
  /** Worker count. */
  workers: number | null;
  /** Coupling commit file limit. */
  couplingMaxFiles: number | null;
  /** Coupling row limit. */
  couplingTopPairs: number | null;
};

/** A coarse phase reported while a scan is in progress. */
export type AnalysisPhase = "history" | "worktree" | "metrics" | "ownership" | "evidence" | "persisting" | "queued";

/** The lifecycle state of an analysis run. */
export type AnalysisRunStatus = "queued" | "running" | "complete" | "partial" | "failed" | "cancelled" | "interrupted";
...
export type DirectoryOwnership = {
  /** Directory path. */
  directory: string;
...
export type Freshness = "fresh" | "historyStale" | "worktreeStale" | "interrupted";
